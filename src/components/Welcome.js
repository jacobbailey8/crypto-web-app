...
function Welcome() {
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center">
        <h1 className='uppercase text-white text-6xl text-center px-1 font-bold transform -translate-y-12'>Find and Track 
            <span className=' bg-gradient-to-r from-purple  to-blue-400 text-transparent bg-clip-text'> Crypto</span>
